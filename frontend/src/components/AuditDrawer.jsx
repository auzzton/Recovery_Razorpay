    ...
    <div style={{
      ...
      {loading ? (
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {data.audit_logs && data.audit_logs.length > 0 ? (
              ...
              <div style={{ color: 'var(--text-muted)', textAlign: 'center', padding: '30px 0', fontSize: '0.9rem' }}>
                No state transition audit logs recorded yet for this workflow.
              </div>
            )}
          </div>
        </div>
        ...
        <div style={{ color: '#ef4444', textAlign: 'center', padding: '40px 0' }}>
          Failed to load audit records for this workflow.
        </div>
      )}
    </div>
  );
